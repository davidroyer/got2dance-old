(function($) {
  ...
  $.fn.gCalReader = function(options) {
    ...
    var defaults = $.extend({
        calendarId: '5hgkoqu9stlv78k7tguskqpdsc@group.calendar.google.com',
        apiKey: 'AIzaSyBEDQhf7itA6iAPJ-p0ENiVrO4B6E4xXSU',
        dateFormat: 'LongDate',
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        $.each(data.items, function(e, item) {
          var eventdate = item.start.dateTime || item.start.dateTime ||'';
